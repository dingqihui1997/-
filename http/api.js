...
export default {
    ...
    getCatsBooks(gender, type, major, minor, start) {
        if (minor) { //获取分类书籍  @param gender 性别排行（male）type 排行类型（hot）major 大类 minor 小类  start 分页开始
    ...
    bookReviews(book_id) { //长评  @param book_id 书籍id
